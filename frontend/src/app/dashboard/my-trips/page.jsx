      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col relative group">
          ...
          <div className="p-5 flex flex-col flex-grow">
            ...
            <Link
              href="/dashboard/trip/santorini"
              className="w-full mt-auto bg-white border border-blue-600 text-blue-600 text-center hover:bg-blue-50 text-sm font-bold py-2.5 rounded-lg transition-colors block"
            >
              Continue Planning
            </Link>
          </div>
